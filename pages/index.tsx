				...
				<header className="min-h-screen">
					...
					<div className="flex flex-col justify-space-between">
						<nav className="py-10 mb-12 flex justify-between sticky top-0 px-10 md:px-20 lg:px-32 backdrop-blur-3xl bg-slate z-10">
							<h1 className="text-4xl font-bold text-indigo-500 hidden md:block">Portfolio</h1>
							<Image src={profile} width={80} height={80} className="rounded-full border-2 border-indigo-500 md:hidden" alt={"Avatar"} />
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:px-32 px-8">
							<div className="text-left mt-12">
								...
								<p className="text-xl py-4 mt-10 text-gray-600 md:text-2xl max-w-2xl dark:text-gray-400">I am an undergraduate student in Informatics who likes to study website programming and web design. I have worked on UI/UX projects and web development several times as a freelance. I really hope I can work with you. 👋</p>
								<div className="flex justify-left gap-6 lg:gap-12 mt-8 text-3xl md:text-4xl lg:text-4xl text-indigo-500">
